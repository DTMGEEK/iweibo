...
public class WeiboHomeAdapter extends BaseAdapter {
    ...
    private List<WeiboInfos> weiboHomeDateList;
    ...
    public WeiboHomeAdapter(Context context,List weiboHomeDateList){
        this.context = context;
        this.weiboHomeDateList = weiboHomeDateList;
    ...
    {
        return weiboHomeDateList.get(position);
    }
    ...
    private void bindView(int position, View view) {
        ...
        WeiboInfos weiboinfo = weiboHomeDateList.get(position);
        Holder holder = null;
